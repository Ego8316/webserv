...
class	ServerCore
{
	...
	private:
		...
		std::vector<struct pollfd>	_poll_fds; //[client 0, client 1, ..., client N, client 1's pipe to cgi, client 1's pipe from cgi, ..., client N's pipe from cgi, server] size = 3N + 1
